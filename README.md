...
in current AI web interfaces, and both need to be stated clearly. One worked up until a recent regression. The other has never existed in any useful form. 
...
"Save as PDF" to save locally. You can also then save those pages for more simply formatted serif or sans-serif HTML than the styled output of the specific HTML scripts. 
